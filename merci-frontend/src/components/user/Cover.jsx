...
// import { fetchProductsByCategory } from "../../redux/slices/categorieSlice";
...
//       navigate(`/products/filter/${selectedCategory}`);
//       // }
//       // onClose();
//     }
//   }, [selectedCategory]);
...
//     setSelectedFilters((prevFilters) => ({
//       ...prevFilters,
//       ratings: prevFilters.ratings.includes(option)
//         ? prevFilters.ratings.filter((rating) => rating !== option)
//         : [...prevFilters.ratings, option],
//     }));
//   };

//   const handleApplyFilters = () => {
//     if (!selectedCategory) {
//       setError("You need to select a category to apply filters");
//     } else {
//       setError("");
...
//         </button>
//       </div>
//       <div className="flex items-center justify-center h-3/4 w-3/4 max-sm:h-4/5 max-sm:w-4/5">
//         <div className="bg-[bisque] p-4 rounded-lg w-full h-full">
//           <p className="text-center text-3xl mb-4">Cover Page</p>
//           <div className="flex gap-4 h-[90%]">
//             <div className="categories w-1/4 min-w-fit">
//               <p className="text-center text-xl font-bold mb-2 border-b-2 border-black">
//                 Categories
//               </p>
//               <div className="bg-white p-2 category-options overflow-y-scroll h-[90%] ">
//                 {categories.map((category, index) => (
//                   <div key={index} className="hover:bg-gray-200 cursor-pointer">
//                     <input
//                       type="radio"
//                       id={category._id}
//                       name="category"
...
//                         min={0}
//                         max={100}
//                         defaultValue={selectedFilters.discountRange}
//                         onChange={(value) =>
//                           setSelectedFilters((prevFilters) => ({
//                             ...prevFilters,
//                             discountRange: value,
//                           }))
//                         }
//                         value={selectedFilters.discountRange}
//                       />
//                       <div>
//                         {selectedFilters.discountRange[0]}% -{" "}
//                         {selectedFilters.discountRange[1]}%
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                     checked={selectedFilters.stockAvailability}
//                     onChange={() =>
//                       setSelectedFilters((prevFilters) => ({
//                         ...prevFilters,
...
//     // append new value to filter.categories
...
//                           name="category"
//                           value={brand._id}
//                           // checked={selectedFilters.brands.brand.includes(
//                           //   brand._id
//                           // )}
...
const Cover = ({ isVisible, onClose }) => {
  ...
  return (
    <div className="max-sm:hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50">
      <div className="absolute top-4 right-4">
        <button
          className="text-white text-xl focus:outline-none"
          onClick={onClose}
